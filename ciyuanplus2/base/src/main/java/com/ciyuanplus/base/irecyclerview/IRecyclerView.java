...
public class IRecyclerView extends RecyclerView {
    ...
    private final RefreshTrigger mRefreshTrigger = new RefreshTrigger() {
        @Override
        public void onStart(boolean automatic, int headerHeight, int finalHeight) {
            if (mRefreshHeaderView instanceof RefreshTrigger) {
    ...
    private final OnLoadMoreScrollListener mOnLoadMoreScrollListener = new OnLoadMoreScrollListener() {
        @Override
    ...
    public IRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        @LayoutRes int refreshHeaderLayoutRes;
        @LayoutRes int loadMoreFooterLayoutRes;
        int refreshFinalMoveOffset;
    ...
    private void setLoadMoreEnabled(boolean enabled) {
        boolean loadMoreEnabled = enabled;
        if (loadMoreEnabled) {
    ...
    private void setRefreshFinalMoveOffset(int refreshFinalMoveOffset) {
    ...
    private void setRefreshHeaderView(@LayoutRes int refreshHeaderLayoutRes) {
        ensureRefreshHeaderContainer();
        final View refreshHeader = LayoutInflater.from(getContext()).inflate(refreshHeaderLayoutRes,
                mRefreshHeaderContainer, false);
    ...
    private void setLoadMoreFooterView(@LayoutRes int loadMoreFooterLayoutRes) {
        ensureLoadMoreFooterContainer();
    ...
    public boolean onInterceptTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                Log.e(TAG, "onInterceptTouchEvent: 按下");
    ...
    private boolean canTriggerRefresh() {
        ...
        if (position == 0) {
            return firstChild.getTop() == mRefreshHeaderContainer.getTop();
        }
        return false;
    }
