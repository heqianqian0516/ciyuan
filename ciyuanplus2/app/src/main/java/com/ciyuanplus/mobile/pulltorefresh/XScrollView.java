...
//    private static final String TAG = "XScrollView";
    ...
    private XScrollChangedListener mScrollChangedListener;
    ...
    private final int mHeaderHeight = 100;
    ...
    private void initWithContext(Context context) {
        ...
        mContentLayout = mLayout.findViewById(R.id.m_content_layout);
        ...
        mHeaderContent = mHeader.findViewById(R.id.m_header_content);
        LinearLayout headerLayout = mLayout.findViewById(R.id.m_header_layout);
        ...
        LinearLayout footLayout = mLayout.findViewById(R.id.m_footer_layout);
...
//        }
    ...
    public void setPullLoadEnable(boolean enable) {
        ...
        if (!mEnablePullLoad) {
            ...
            mFooterView.setOnClickListener(v -> startLoadMore());
        }
    }
    ...
    public void setXScrollChangedListener(XScrollChangedListener listener) {
    ...
    private void updateHeaderHeight(float delta) {
        ...
        post(() -> XScrollView.this.fullScroll(ScrollView.FOCUS_UP));
    }

    private void resetHeaderHeight() {
        final int height = mHeader.getVisibleHeight();
        if (height == 0) return;
        ...
        if (mPullRefreshing) {
            ...
            final int finalHeight1 = finalHeight;
            mHeader.setState(XHeaderView.STATE_NORMAL);
            mScrollBack = SCROLL_BACK_HEADER;
            postDelayed(() -> mScroller.startScroll(0, mScroller.getCurrY(), 0, finalHeight1 - height, SCROLL_DURATION), 100);
        }
    ...
    private void updateFooterHeight(float delta) {
        ...
        // scroll to bottom
        post(() -> XScrollView.this.fullScroll(ScrollView.FOCUS_DOWN));
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.i("scrollView==", "xxxx==" + rawX + "lastX==" + mLastX);
                mLastX = rawX;
    ...
    private void setOnScrollListener(OnScrollListener l) {
        mScrollListener = l;
    }
    ...
    public interface XScrollChangedListener {
