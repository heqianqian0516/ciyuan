 ...
 */
public class RequestCommunityPostsApiParameter extends ApiParameter {
...
//    new PlotParmeter(commid,uuid,state,page,pagesize,lastid,biztype).getRequestBody()
    ...
    public RequestCommunityPostsApiParameter(String communityUuid, String searchValue, String pager, String pageSize, String lastId, String postType) {
        this.lastId = lastId;
