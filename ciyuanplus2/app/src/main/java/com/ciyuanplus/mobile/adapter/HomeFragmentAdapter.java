...
public class HomeFragmentAdapter extends BaseQuickAdapter<FreshNewItem, BaseViewHolder> {


    public HomeFragmentAdapter(@Nullable List<FreshNewItem> data) {
        super(R.layout.item_home_lists, data);
    }
