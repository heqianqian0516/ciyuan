...
public class ImgSelConfig {
    ...
    public static class Builder implements Serializable {
        ...
        public Builder(Context context, ImageLoader loader) {
            ...
            title = context.getResources().getString(R.string.image_select_image);
            titleBgColor = Color.parseColor("#3F51B5");
            titleColor = Color.WHITE;

            btnText = context.getResources().getString(R.string.image_select_confirm);
            btnBgColor = Color.TRANSPARENT;
            btnTextColor = Color.WHITE;

            allImagesText = context.getResources().getString(R.string.image_select_all_images);
