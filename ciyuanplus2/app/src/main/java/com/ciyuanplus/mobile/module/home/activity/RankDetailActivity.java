 ...
 * 排行榜详情页
 */
public class RankDetailActivity extends ForumDetailActivity implements EventCenterManager.OnHandleEventListener {
    ...
    private ImageView rnakShare;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.setContentView(R.layout.activity_rank_detail);
        initViewData();
    }

    private void initViewData() {
        mTimeText = findViewById(R.id.tv_time);
        mSexIconImage = findViewById(R.id.iv_sex_icon);
        mContentText = findViewById(R.id.tv_content);
        mNineGrid = findViewById(R.id.nineGrid);
        mFollowImage = findViewById(R.id.tv_add);
        mHeadIconImage = findViewById(R.id.riv_head_image);
        mBrowseCount = findViewById(R.id.tv_browse_count);
        mCommentCount = findViewById(R.id.tv_comment_count);
        ...
        coverVideo = findViewById(R.id.detail_player);
        mNullCommentLayout = findViewById(R.id.ll_empty_view);
        rankBack = findViewById(R.id.rank_back);
        rnakShare = findViewById(R.id.rank_share);
        ...
        rnakShare.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RankDetailActivity.this, ShareNewsPopupActivity.class);
    ...
    public void updateView() {
        ...
        if (!TextUtils.isEmpty(mPresenter.mItem.imgs)) {
            ...
            if (!StringUtils.isEmpty(mPresenter.mItem.postType) && StringUtils.equals(mPresenter.mItem.postType, "1")) {
                ...
                coverVideo.getFullscreenButton().setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        coverVideo.startWindowFullscreen(RankDetailActivity.this, false, true);
                    }
                });
        ...
        mCommonDetailBottomOperaLp1LikeImage.setImageResource(mPresenter.mItem.isLike == 1 ? R.drawable.thumbs_up : R.drawable.unthumbs_up);
        Drawable drawable = getResources().getDrawable(mPresenter.mItem.isLike == 1 ? R.drawable.thumbs_up : R.drawable.unthumbs_up);
        mLikeCount.setCompoundDrawablesWithIntrinsicBounds(null, drawable, null, null);
    ...
    public void bindTopLayout() {
      /*  LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View headView = inflater != null ? inflater.inflate(R.layout.activity_rank_detail, null) : null;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constants.REQUEST_CODE_SELECT_EDIT_DELETE_NEWS && resultCode == RESULT_OK) {
            ...
            if (Utils.isStringEquals(SelectEditOrDeleteNewsActivity.EDIT, opera)) {
                Intent intent = new Intent(RankDetailActivity.this, StartTwitterActivity.class);
        ...
        public void performRealClick(View view) {
            ...
            if (id == R.id.tv_add) {
                ...
                if (!LoginStateManager.isLogin()) {
                    ...
                    Intent intent = new Intent(RankDetailActivity.this, LoginActivity.class);
                    startActivity(intent);
                    return;
                }
                ...
                Intent intent = new Intent(RankDetailActivity.this, OthersActivity.class);
