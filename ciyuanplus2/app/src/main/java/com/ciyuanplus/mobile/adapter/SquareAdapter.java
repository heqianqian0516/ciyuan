        ...
        public void performRealClick(View view) {
            if (view.getId() == R.id.iv_follow
                ...
                requestFollowUser(item);
                    ...
                    || view.getId() == R.id.m_list_item_main_forum_seek_help_share_image) {
                FreshNewItem item = (FreshNewItem) view.getTag();
                ...
                mContext.startActivity(intent);
                    ...
                    || view.getId() == R.id.m_list_item_main_forum_seek_help_like_image
                    || view.getId() == R.id.m_list_item_main_forum_food_comment_like_image) {
                FreshNewItem item = (FreshNewItem) view.getTag();
...
//                    view.getId() == R.id.m_list_item_main_forum_daily_more_image ||
//                    view.getId() == R.id.m_list_item_main_forum_seek_help_more_image
//                    ) {// 调到点评页面
//                if (!LoginStateManager.isLogin()) {
//                    Intent intent = new Intent(mContext, LoginActivity.class);
//                    mContext.startActivity(intent);
...
//            }
    ...
    private List<FreshNewItem> mNewsList;
    ...
    public SquareAdapter(Activity mContext, List<FreshNewItem> mNewsList, View.OnClickListener mItemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case 0:
                holder = new ViewHolderNews(view);//新鲜事
                break;
            case 1:
                holder = new ViewHolderPost(view); //杂谈
                break;
            case 2:
                holder = new ViewHolderStuff(view); //买卖
                break;
//            case 3:
//                holder = new ViewHolderDaily(view);
//                break;
            case 4:
                holder = new ViewHolderFood(view); //推荐
                break;
            case 5:
                holder = new ViewHolderSeekHelp(view); //求助
                break;
        }
...
//                holderNews.communityName.setText(item.communityName);
                ...
                if (item.isAnonymous == 1) {
                    ...
                    holderNews.follow.setVisibility(View.INVISIBLE);// 匿名不需要+ta
//                    holderNews.sex.setVisibility(View.GONE);
//                    holderNews.neighbor.setVisibility(View.INVISIBLE);


                    Glide.with(mContext).load(R.mipmap.default_head_).apply(options).into(holderNews.head);
                } else {
//                    holderNews.sex.setVisibility(View.VISIBLE);
                    Glide.with(mContext).load(Constants.IMAGE_LOAD_HEADER + item.photo).apply(options).into(holderNews.head);
                }
                ...
                holderNews.browseCount.setText(Utils.formateNumber(item.browseCount));
                holderNews.typeName.setText("杂谈");
                holderNews.styleNameEn.setText("talk");
                holderNews.lineView.setBackgroundColor(Color.parseColor("#ddb5ff"));
                break;
            case 1:
                ...
                if (item.isFollow == 0 && !Utils.isStringEquals(item.userUuid,
                    ...
                    holderPost.follow.setVisibility(View.INVISIBLE);
                }
                // 性别
...
//                }
                ...
                if (item.isAnonymous == 1) {
                    ...
                    holderPost.follow.setVisibility(View.INVISIBLE);// 匿名不需要+ta
//                    holderPost.sex.setVisibility(View.GONE);
//                    holderPost.neighbor.setVisibility(View.INVISIBLE);
                    Glide.with(mContext).load(R.mipmap.default_head_).apply(options).into(holderPost.head);
                } else {
//                    holderPost.sex.setVisibility(View.VISIBLE);
                    Glide.with(mContext).load(Constants.IMAGE_LOAD_HEADER + item.photo).apply(options).into(holderPost.head);
                }
                ...
                holderPost.browseCount.setText(Utils.formateNumber(item.browseCount));


                holderPost.typeName.setText("杂谈");
                holderPost.styleNameEn.setText("talk");
                holderPost.lineView.setBackgroundColor(Color.parseColor("#ddb5ff"));
                break;
            case 2:
                ...
                if (item.isFollow == 0 && !Utils.isStringEquals(item.userUuid,
                    ...
                    holderStuff.follow.setVisibility(View.INVISIBLE);
                }
                // 性别
...
//                }
                ...
                if (item.isAnonymous == 1) {
                    ...
                    holderStuff.follow.setVisibility(View.INVISIBLE);// 匿名不需要+ta
//                    holderStuff.sex.setVisibility(View.GONE);
                    holderStuff.neighbor.setVisibility(View.INVISIBLE);
                    Glide.with(mContext).load(R.mipmap.default_head_).apply(options).into(holderStuff.head);
                } else {
//                    holderStuff.sex.setVisibility(View.VISIBLE);
                    Glide.with(mContext).load(Constants.IMAGE_LOAD_HEADER + item.photo).apply(options).into(holderStuff.head);
                }
                ...
                holderStuff.browseCount.setText(Utils.formateNumber(item.browseCount));
                holderStuff.price.setText(item.price == 0.0f ? "免费" : "¥" + item.price + "");

                holderStuff.typeName.setText("买卖");
                holderStuff.styleNameEn.setText("trade");
                holderStuff.lineView.setBackgroundColor(Color.parseColor("#ffe465"));
                break;
            case 3:
                ...
                Glide.with(mContext).load(Constants.IMAGE_LOAD_HEADER + item.someThree).apply(options).into(holderDaily.head);
                ...
                if (Utils.isStringEmpty(item.imgs)) {
                    ...
                    Glide.with(mContext).load(Constants.IMAGE_LOAD_HEADER + images[0]).apply(options).into(holderDaily.image);
                }
            ...
            case 4:
                ...
                if (item.isFollow == 0 && !Utils.isStringEquals(item.userUuid,
                    ...
                    holderFood.follow.setVisibility(View.INVISIBLE);
                }
//                // 性别
...
//                }
                ...
                Glide.with(mContext).load(Constants.IMAGE_LOAD_HEADER + item.photo).apply(options).into(holderFood.head);
...
//                }
                ...
                holderFood.like.setImageResource(item.isLike == 1 ? R.drawable.icon_like : R.drawable.icon_unlike);
...
//                holderFood.opera.setOnClickListener(myOnClickListener);
                ...
                holderFood.like.setTag(item);
                holderFood.like.setOnClickListener(myOnClickListener);
                ...
                holderFood.browseCount.setText(Utils.formateNumber(item.browseCount));
                holderFood.time.setText(Utils.getFormattedTimeString(item.createTime));


                break;
            case 5:
                ViewHolderSeekHelp holderSeekHelp = (ViewHolderSeekHelp) holder;

                holderSeekHelp.name.setText(item.nickname);// 姓名
                // 关注按钮
                if (item.isFollow == 0 && !Utils.isStringEquals(item.userUuid,
                        UserInfoData.getInstance().getUserInfoItem().uuid)) {
                    holderSeekHelp.follow.setVisibility(View.VISIBLE);
                } else {
                    holderSeekHelp.follow.setVisibility(View.INVISIBLE);
                }
                // 性别
//                holderSeekHelp.sex.setImageResource(item.getBigSexImageResource());

                if (Utils.isStringEmpty(item.imgs)) {
                    holderSeekHelp.threeGrideView.setVisibility(View.GONE);
                    holderSeekHelp.threeGrideView.setTag("");
                    holderSeekHelp.imgNumLayout.setVisibility(View.GONE);

                } else {
                    holderSeekHelp.threeGrideView.setVisibility(View.VISIBLE);
                    String oldImages = (String) holderSeekHelp.threeGrideView.getTag();

//                    String[] imgeNums = item.imgs.split(",");
//                    if (imgeNums.length > 3) {
//                        holderSeekHelp.imgNumLayout.setVisibility(View.VISIBLE);
//                        holderSeekHelp.imgNum.setText("" + imgeNums.length);
//                    }
                    if (!Utils.isStringEquals(oldImages, item.imgs)) { // 防止闪烁
                        holderSeekHelp.threeGrideView.setTag(item.imgs);
                        holderSeekHelp.threeGrideView.setDataSource(item.imgs.split(","), item);
                    }
                }
//                holderSeekHelp.location.setText(item.placeName);
//                holderSeekHelp.markView.setValue(item.postScore);

                if (!Utils.isStringEmpty(item.description)) {
                    holderSeekHelp.text.setMaxLines(2);
                    holderSeekHelp.text.setVisibility(View.VISIBLE);
                    if (mContext instanceof NewsSearchActivity) {
                        holderSeekHelp.text.setText(Utils.matcherSearchTitle(0xff2279AB, item.description.replace("\r", "\n"), ((NewsSearchActivity) mContext).mSearchValue));
                    } else {
                        holderSeekHelp.text.setText(item.description.replace("\r", "\n"));
                    }
                } else {
                    holderSeekHelp.text.setVisibility(View.GONE);
                }
                // 邻里标签
//                if (Utils.isStringEquals(item.currentCommunityUuid, UserInfoData.getInstance().getUserInfoItem().currentCommunityUuid) && !Utils.isStringEquals(item.userUuid, UserInfoData.getInstance().getUserInfoItem().uuid)) {
//                    holderSeekHelp.neighbor.setVisibility(View.VISIBLE);
//                } else {
//                    holderSeekHelp.neighbor.setVisibility(View.INVISIBLE);
//                }

                Glide.with(mContext).load(Constants.IMAGE_LOAD_HEADER + item.photo)
                        .apply(options).into(holderSeekHelp.head);

                if (item.isAnonymous == 1) {
                    holderSeekHelp.name.setText(mContext.getResources().getString(R.string.string_user_anonymous_alert));
                    holderSeekHelp.follow.setVisibility(View.INVISIBLE);// 匿名不需要+ta
//                    holderPost.sex.setVisibility(View.GONE);
//                    holderPost.neighbor.setVisibility(View.INVISIBLE);
                    Glide.with(mContext).load(R.mipmap.default_head_).apply(options).into(holderSeekHelp.head);
                } else {
//                    holderPost.sex.setVisibility(View.VISIBLE);
                    Glide.with(mContext).load(Constants.IMAGE_LOAD_HEADER + item.photo).apply(options).into(holderSeekHelp.head);
                }

                holderSeekHelp.likeText.setText(Utils.formateNumber(item.likeCount));
                holderSeekHelp.commentText.setText(Utils.formateNumber(item.commentCount));
                holderSeekHelp.seekHelpImage.setImageResource(item.isLike == 1 ? R.drawable.icon_like : R.drawable.icon_unlike);

                holderSeekHelp.shareImage.setTag(item);
                holderSeekHelp.shareImage.setOnClickListener(myOnClickListener);
                holderSeekHelp.seekHelpImage.setTag(item);
                holderSeekHelp.seekHelpImage.setOnClickListener(myOnClickListener);
                holderSeekHelp.follow.setTag(item);
                holderSeekHelp.head.setTag(R.id.glide_item_tag, item);
                holderSeekHelp.follow.setOnClickListener(myOnClickListener);
                holderSeekHelp.head.setOnClickListener(myOnClickListener);
                holderSeekHelp.browseCount.setText(Utils.formateNumber(item.browseCount));
                holderSeekHelp.resolveStatusImg.setVisibility(item.isResolved == 1 ? View.VISIBLE : View.GONE);
                holderSeekHelp.resolveStatusText.setVisibility(item.isResolved == 1 ? View.VISIBLE : View.GONE);


                holderSeekHelp.typeName.setText("求助");
                holderSeekHelp.styleNameEn.setText("question");
                holderSeekHelp.lineView.setBackgroundColor(Color.parseColor("#ffb2b3"));
                holderSeekHelp.time.setText(Utils.getFormattedTimeString(item.createTime));
                break;
        }
    }
...
//            return 5;
        if (item.bizType == 0)
            return 0;
        if (item.bizType == 8 || item.bizType == 13)
            return 1;
        if (item.bizType == 1)
            return 2;
        if (item.bizType == 6 || item.bizType == 7 || item.bizType == 12)
            return 4;
        if (item.bizType == 4)
            return 5;
...
//            }
    ...
    class ViewHolderNews extends ViewHolder {
        ...
        ImageView follow;
        //        @BindView(R.id.m_list_item_main_forum_news_is_neighbor)
//        ImageView neighbor;
...
//        ImageView sex;
        ...
        TextView likeNumber;
        //        @BindView(R.id.m_list_item_main_forum_news_more_image)
//        ImageView more;
        @BindView(R.id.m_list_item_main_forum_news_comment_text)
        TextView commentNumber;
        //        @BindView(R.id.m_list_item_main_forum_news_community_text)
//        TextView communityName;
        ...
        TextView typeName;
        @BindView(R.id.tv_style_en)
        TextView styleNameEn;
    ...
    class ViewHolderPost extends ViewHolder {
        ...
        ImageView like;
        //        @BindView(R.id.m_list_item_main_forum_post_head_sex)
//        ImageView sex;
...
//        ImageView likeImage;
        ...
        ThreeGrideView images;
        @BindView(R.id.m_list_item_main_forum_food_opera_text)
        TextView opera;
        @BindView(R.id.tv_browse_count)
        TextView browseCount;
        @BindView(R.id.m_list_item_main_forum_food_comment_like_image)
        ImageView like;
        @BindView(R.id.m_list_item_main_forum_food_time_text)
        TextView time;
    ...
    class ViewHolderSeekHelp extends ViewHolder {
        @BindView(R.id.m_list_item_main_forum_seek_help_like_image)
        ImageView seekHelpImage;
        @BindView(R.id.m_list_item_main_forum_seek_help_like_text)
        TextView likeText;
        @BindView(R.id.m_list_item_main_forum_seek_help_comment_image)
        ImageView commentImage;
        @BindView(R.id.m_list_item_main_forum_seek_help_comment_text)
        TextView commentText;
        @BindView(R.id.m_list_item_main_forum_seek_help_share_image)
        ImageView shareImage;

        @BindView(R.id.m_list_item_main_forum_seek_help_images)
        ThreeGrideView threeGrideView;
        @BindView(R.id.m_list_item_main_forum_seek_help_title_text)
        TextView text;
        @BindView(R.id.tv_browse_count)
        TextView browseCount;
        @BindView(R.id.ll_image_num)
        LinearLayout imgNumLayout;
        @BindView(R.id.tv_image_num)
        TextView imgNum;
        @BindView(R.id.tv_resolve_status)
        TextView resolveStatusText;
        @BindView(R.id.iv_resolve_status)
        ImageView resolveStatusImg;
        ...
        @BindView(R.id.view_line)
        View lineView;
        @BindView(R.id.m_list_item_main_forum_seek_help_time_text)
        TextView time;
