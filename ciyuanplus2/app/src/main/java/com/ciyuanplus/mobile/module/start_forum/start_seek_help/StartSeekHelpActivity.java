...
public class StartSeekHelpActivity extends MyBaseActivity implements StartSeekHelpContract.View {
 ...
 StartSeekHelpPresenter mPresenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.activity_start_seek_help);
...
//                .build().inject(this);
        ...
        m_js_common_title.setCenterText("发布求助");
        mStartNoteContent.setAlertText("请输入您的求助内容～");
        ...
        m_js_common_title.setRightClickListener(new MyOnClickListener() {
            ...
            public void performRealClick(View view) {
                ...
                mPresenter.requestPost(ApiContant.REQUEST_help, 4);
    ...
    public void onBackPressed() {
        if (Utils.isStringEmpty(getEditData())) {
            ...
            CustomDialog.Builder builder = new CustomDialog.Builder(StartSeekHelpActivity.this);
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.m_start_note_add_image:
                ...
                Intent intent = new Intent(StartSeekHelpActivity.this, SelectImagePopActivity.class);
                StartSeekHelpActivity.this.startActivityForResult(intent, Constants.REQUEST_CODE_SELECT_PITCURE_OPTION);
                break;
        }
    }
