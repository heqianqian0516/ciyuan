...
import com.ciyuanplus.mobile.net.bean.NoticeListInfoItem;
 ...
 */
public class NoticeListResponse extends ResponseData {
    public NoticeListInfoItem noticeListInfo;

    public NoticeListResponse(String data) {
        super(data);
