...
public class ZWSignCalendarView extends FrameLayout {
    ...
    private void init(AttributeSet attrs, int def) {
        ...
        config.weekTextSize = array.getDimension(R.styleable.ZWSignCalendarView_weekTextSize, sp2px(15));
        config.calendarTextColor = array.getColor(R.styleable.ZWSignCalendarView_calendarTextColor, Color.GRAY);
        config.calendarTextSize = array.getDimension(R.styleable.ZWSignCalendarView_calendarTextSize, sp2px(15));
