...
public class ShareH5GameInvitePopup extends MyBaseActivity implements UMShareListener {

    private final Activity mContext = ShareH5GameInvitePopup.this;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.activity_share_h5_game_invite_popup);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constants.REQUEST_CODE_SELECT_CONTACTS && resultCode == RESULT_OK) {
            ...
            cursor.moveToFirst();
            String num = ShareH5GameInvitePopup.this.getContactPhone(cursor);
            //打开短信app
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.m_share_invite_pop_up_wei_circle:
                ...
                web.setThumb(Utils.isStringEmpty(icon) ? new UMImage(mContext, R.mipmap.ic_launcher) : new UMImage(mContext, Constants.IMAGE_LOAD_HEADER + icon));
                web.setDescription(desc);//描述
                new ShareAction(mContext).setPlatform(SHARE_MEDIA.WEIXIN_CIRCLE)
                        .withMedia(web)
                        .setCallback(ShareH5GameInvitePopup.this)
                        .share();
                break;
            ...
            case R.id.m_share_invite_pop_up_cancel:
                mContext.setResult(RESULT_CANCELED, null);
                mContext.finish();
                break;
        }
    }
