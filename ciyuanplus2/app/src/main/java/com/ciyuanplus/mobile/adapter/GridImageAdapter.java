...
public class GridImageAdapter extends RecyclerView.Adapter<GridImageAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mAddImg = view.findViewById(R.id.iv_add);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.item_grid_photo, viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mAddImg.setImageResource(R.drawable.add_image);
            viewHolder.mAddImg.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            if (mimeType == PictureMimeType.ofAudio()) {
                viewHolder.mAddImg.setImageResource(R.drawable.audio_placeholder);
            } else {
