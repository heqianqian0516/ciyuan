...
public class OrderDetailList extends ResponseData {


    public OrderDetailItem orderDetailItem;

    public OrderDetailList(String data) {
        super(data);
        ...
        try {
            ...
            orderDetailItem = gson.fromJson(data1, OrderDetailItem.class);
